  ...
  (
    ...
    useEffect(() => {
      const handleKeyDown = (e: KeyboardEvent) => {
        if (
          document.activeElement === (combinedRef as React.RefObject<HTMLInputElement>)?.current
        ) {
          if (e.key === 'ArrowUp') {
            handleIncrement()
    ...
    return (
      <div className="flex grow items-center">
        <NumericFormat
          ...
          className="relative [appearance:textfield] rounded-r-none [&::-webkit-inner-spin-button]:appearance-none
